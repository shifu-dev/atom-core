...
//         constexpr mem_ptr_functions(const type* that)
//             : base_type(that)
//         {}

//         template <typename type>
//         constexpr mem_ptr_functions(type* that)
//             : base_type(that)
//         {}
...
//     class ptr: public mem_ptr_functions<const type*, const type*>
//     {
//         using this_type = const type*;
//         using base_type = mem_ptr_functions<const type*, this_type>;

//     public:
//         constexpr ptr(const const type*& that)
//             : base_type(that)
//         {}
...
//     export template <typename type>
//     ptr(const type* ptr) -> const type*;

//     /// --------------------------------------------------------------------------------------------
//     ///
//     /// --------------------------------------------------------------------------------------------
//     export template <typename type>
//     class mut_ptr: public mem_ptr_functions<type*, type*>
//     {
//         using this_type = type*;
//         using base_type = mem_ptr_functions<type*, this_type>;

//     public:
//         constexpr mut_ptr(const type*& that)
//             : base_type(that)
//         {}

...
namespace atom
{
    ...
    concept _riter_of = requires { requires rconvertible_to<typename iter_type::elem_type, type>; };

    template <typename iter_type>
    concept _rmut_iter = requires(iter_type it) {
        {
            it.mut_value()
        } -> rconvertible_to<typename iter_type::elem_type&>;
    };
    ...
    concept riter = requires(iter_type it, const iter_type cit) {
        ...
        {
            cit.value()
        } -> rconvertible_to<const typename iter_type::elem_type&>;
        {
            it.next()
        } -> rconvertible_to<iter_type&>;
    };
    ...
    concept rarray_iter = requires(const iter_type cit) {
        ...
        {
            cit.data()
        } -> rconvertible_to<mem_ptr<typename iter_type::elem_type>>;
    };
    ...
    concept rmut_array_iter = requires(iter_type it) {
        ...
        {
            it.mut_data()
        } -> rconvertible_to<mut_mem_ptr<typename iter_type::elem_type>>;
    };

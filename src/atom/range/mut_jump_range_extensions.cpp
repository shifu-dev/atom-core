export module atom.core:range.mut_jump_range_extensions;
...
namespace atom
{
    ...
    {
        using base_type =
            _mut_bidi_range_extensions_impl<range_type, _tconst_range_extensions_impl>;
    ...
    class mut_jump_range_extensions
        : public mut_bidi_range_extensions<range_type, _tconst_range_extensions>
    {

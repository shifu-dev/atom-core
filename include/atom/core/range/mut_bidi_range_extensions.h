...
namespace atom
{
    ...
    class _mut_bidi_range_extensions_impl
        : public _mut_fwd_range_extensions_impl<range_t, _const_range_extensions_impl_t>
    {
        using base_t = _mut_fwd_range_extensions_impl<range_t, _const_range_extensions_impl_t>;
    ...
    class mut_bidi_range_extensions
        : public mut_fwd_range_extensions<range_t, _const_range_extensions_t>
    {
        using base_t = mut_fwd_range_extensions<range_t, _const_range_extensions_t>;
    ...
    /// --------------------------------------------------------------------------------------------
    template <typename range_t>
    class mut_bidi_range_extensions<range_t, void>
        : public mut_bidi_range_extensions<range_t,
              bidi_range_extensions<range_t, _mut_bidi_range_extensions_impl<range_t>>>
    {
        using base_t = mut_bidi_range_extensions<range_t,
            bidi_range_extensions<range_t, _mut_bidi_range_extensions_impl<range_t>>>;

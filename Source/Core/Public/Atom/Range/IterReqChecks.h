...
#define _ATOM_SATISFIES_ITER(RIter, TIter) \
    static_assert(RIter<TIter>, \
    "{" #TIter "} does not satisfy {" #RIter "} requirement.")
...
#define _ATOM_SATISFIES_MUT_ITER(RMutIter, TIter) \
    static_assert(RMutIter<TIter>, \
    "{" #TIter "} does not satisfy {" #RMutIter "} requirement.")
...
#define _ATOM_SATISFIES_ITER_PAIR_OF(RIterPairOf, TIter, TIterEnd, T) \
    ...
    "{" #TIter ", " #TIterEnd "} does not satisfy {" #RIterPairOf "} requirement for type {" #T "}.")
...
#define ATOM_SATISFIES_ITER_PAIR(TIter, TIterEnd)             _ATOM_SATISFIES_ITER_PAIR(RIterPair, TIter, TIterEnd)
#define ATOM_SATISFIES_ITER_PAIR_OF(TIter, TIterEnd, T)       _ATOM_SATISFIES_ITER_PAIR_OF(RIterPairOf, TIter, TIterEnd, T)
#define ATOM_SATISFIES_MUT_ITER_PAIR(TIter, TIterEnd)         _ATOM_SATISFIES_MUT_ITER_PAIR(RMutIterPair, TIter, TIterEnd)
#define ATOM_SATISFIES_MUT_ITER_PAIR_OF(TIter, TIterEnd, T)   _ATOM_SATISFIES_MUT_ITER_PAIR_OF(RMutIterPairOf, TIter, TIterEnd, T)
...
#define ATOM_SATISFIES_MUT_FWD_ITER_PAIR(TIter, TIterEnd)       _ATOM_SATISFIES_MUT_ITER_PAIR(RMutFwdIterPair, TIter, TIterEnd)
#define ATOM_SATISFIES_MUT_FWD_ITER_PAIR_OF(TIter, TIterEnd, T) _ATOM_SATISFIES_MUT_ITER_PAIR_OF(RMutFwdIterPairOf, TIter, TIterEnd, T)

#define ATOM_SATISFIES_FWD_ITER_TEMP(TIterTemp)                 _ATOM_SATISFIES_ITER_TEMP(RFwdIter, TIterTemp)
#define ATOM_SATISFIES_MUT_FWD_ITER_TEMP(TIterTemp)             _ATOM_SATISFIES_MUT_ITER_TEMP(RFwdIter, TIterTemp)
...
#define ATOM_SATISFIES_MUT_BIDI_ITER_PAIR(TIter, TIterEnd)       _ATOM_SATISFIES_MUT_ITER_PAIR(RMutBidiIterPair, TIter, TIterEnd)
#define ATOM_SATISFIES_MUT_BIDI_ITER_PAIR_OF(TIter, TIterEnd, T) _ATOM_SATISFIES_MUT_ITER_PAIR_OF(RMutBidiIterPairOf, TIter, TIterEnd, T)

#define ATOM_SATISFIES_BIDI_ITER_TEMP(TIterTemp)                 _ATOM_SATISFIES_ITER_TEMP(RBidiIter, TIterTemp)
#define ATOM_SATISFIES_MUT_BIDI_ITER_TEMP(TIterTemp)             _ATOM_SATISFIES_MUT_ITER_TEMP(RBidiIter, TIterTemp)
...
#define ATOM_SATISFIES_MUT_JUMP_ITER_PAIR(TIter, TIterEnd)       _ATOM_SATISFIES_MUT_ITER_PAIR(RMutJumpIterPair, TIter, TIterEnd)
#define ATOM_SATISFIES_MUT_JUMP_ITER_PAIR_OF(TIter, TIterEnd, T) _ATOM_SATISFIES_MUT_ITER_PAIR_OF(RMutJumpIterPairOf, TIter, TIterEnd, T)

#define ATOM_SATISFIES_JUMP_ITER_TEMP(TIterTemp)                 _ATOM_SATISFIES_ITER_TEMP(RJumpIter, TIterTemp)
#define ATOM_SATISFIES_MUT_JUMP_ITER_TEMP(TIterTemp)             _ATOM_SATISFIES_MUT_ITER_TEMP(RJumpIter, TIterTemp)
...
#define ATOM_SATISFIES_MUT_ARR_ITER_PAIR(TIter, TIterEnd)       _ATOM_SATISFIES_MUT_ITER_PAIR(RMutArrIterPair, TIter, TIterEnd)
#define ATOM_SATISFIES_MUT_ARR_ITER_PAIR_OF(TIter, TIterEnd, T) _ATOM_SATISFIES_MUT_ITER_PAIR_OF(RMutArrIterPairOf, TIter, TIterEnd, T)

#define ATOM_SATISFIES_ARR_ITER_TEMP(TIterTemp)                 _ATOM_SATISFIES_ITER_TEMP(RArrIter, TIterTemp)
#define ATOM_SATISFIES_MUT_ARR_ITER_TEMP(TIterTemp)             _ATOM_SATISFIES_MUT_ITER_TEMP(RArrIter, TIterTemp)

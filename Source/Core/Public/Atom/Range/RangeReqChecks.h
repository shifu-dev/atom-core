...
#define ATOM_SATISFIES_ARR_RANGE_TEMP(TRange)           _ATOM_SATISFIES_RANGE_TEMP(RArrRange, TRange)
...
#define ATOM_SATISFIES_MUT_ARR_RANGE_TEMP(TRange)       _ATOM_SATISFIES_RANGE_TEMP(RMutArrRange, TRange)
...
#define ATOM_SATISFIES_MUT_COMMON_RANGE_TEMP(TRange)    _ATOM_SATISFIES_RANGE_TEMP(RMutCommonRange, TRange)

...
namespace Atom
{
    ...
    {
        return ExceptionSource{ .line = src.line(),
            .column = src.column(),
            // TODO: Fix this usage.
    ...
    inline IndexOutOfRangeException::IndexOutOfRangeException(
        ...
        : OutOfRangeException(mov(msg))
        , index{ index }
        , begin{ begin }
        , end{ end }
    {}

    inline IndexOutOfRangeException::IndexOutOfRangeException(usize index, usize begin, usize end)
        : OutOfRangeException()
        , index{ index }
        , begin{ begin }
        , end{ end }

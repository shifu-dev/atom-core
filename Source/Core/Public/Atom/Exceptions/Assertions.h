...
#define ATOM_DEBUG_ASSERT(assertion, exception) \
    ATOM_DEBUG_IF if (!(assertion)) throw exception
...
#define ATOM_DEBUG_EXPECTS(assertion) \
    ATOM_DEBUG_EXPECTS_MSG(assertion, TEXT(""))

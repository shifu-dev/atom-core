...
namespace Atom
{
    ...
    template <tname TImpl>
    constexpr fn _ConstArrImplHelper<TImpl>::operator [](usize index) const noex -> const TElem&
    {
    ...
    template <tname TImpl>
    constexpr fn _ConstArrImplHelper<TImpl>::ElemFront() const noex -> const TElem&
    {
    ...
    template <tname TImpl>
    constexpr fn _ConstArrImplHelper<TImpl>::ElemBack() const noex -> const TElem&
    {
        ATOM_DEBUG_EXPECTS(!IsEmpty()) << OutOfRangeException(
